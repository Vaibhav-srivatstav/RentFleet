                    ...
                    <div className={s.navbarBackground(scrolled)}>
                        <div className={s.contentContainer}>
                            ...
                            <div className={s.desktopNav}>
                                <div className={s.navLinksContainer}>{navLinks.map((link, i) => {
                                    ...
                                    return (
                                        <React.Fragment key={link.path} >
                                            ...
                                            {i < navLinks.length - 1 && (<div className={s.navDivider} />)}
                                        </React.Fragment>
                                    )
                                })}</div>
                            </div>
                            <div className={s.mobileMenuButton}>
                                <button ref={buttonRef} onClick={() => setIsOpen((v) => !v)} className={s.mobileMenuButton} aria-label="Toggle menu" aria-expanded={isOpen}>
                                    {isOpen ? (
                                        <X className='h-5 w-5' />
                                    ) : (
