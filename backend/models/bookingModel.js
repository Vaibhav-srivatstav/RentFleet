...
const carSummarySchema = new Schema(
    {
        id: { type: Schema.Types.ObjectId, ref: "Car", required: true },//car model 
...
const bookingSchema = new Schema(
    {
        userId: { type: Schema.Types.ObjectId, ref: "User", required: true },//user model 
    ...
    { timestamps: true }
);//customer details and shipping address with payment status 
...
const blockingStatuses = ['prnding', 'active', 'upcoming'];
