...
import { carPageStyles } from "../assets/dummyStyle";
...
const Vehicles = () => {
  ...
  const fetchCars = async () => {
    ...
    try {
      const res = await axios.get(`${base}/api/vehicle`, {
        params: { limit },
    ...
    <div className={carPageStyles.pageContainer}>
      ...
      <div className={carPageStyles.contentContainer}>
        <div className={carPageStyles.headerContainer}>
          ...
          <h1 className={carPageStyles.title}> Car Collection</h1>
          <p className={carPageStyles.subtitle}>
            Discover our exclusive fleet of vehicles. Each car is ready for your journey.
          </p>
        </div>
