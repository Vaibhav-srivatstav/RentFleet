...
import carsData from "../assets/vehicleData";
import { carDetailStyles } from "../assets/dummyStyle";
        ...
        <div className={carDetailStyles.mainLayout}>
          <div className={carDetailStyles.leftColumn}>
            <div className={carDetailStyles.imageCarousel}>
              ...
              />
              {((carImages.length ?? 0 )> 0 || (car.image && car.image !== "")) && (
                <div className={carDetailStyles.carouselIndicators}>
                  {((carImages.length ?? 0) > 0 ? carImages : [car.image]).map(
                    (_, idx) => (
                      <button
                        key={idx}
            ...
            <div className={carDetailStyles.aboutSection}>
              ...
              <p className={carDetailStyles.aboutText}>
                Experience in the {car.name}. With its{" "}
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="flex items-center">
                  <FaCheckCircle className="text-gray-800 mr-2 text-sm" />
                  <span className="text-gray-200 text-sm">
                    Free cancellation
                  </span>
                </div>
                <div className="flex items-center">
                  <FaCheckCircle className="text-grya-800 mr-2 text-sm" />
                  <span className="text-gray-200 text-sm">
