...
import { homeVehicleStyles as styles } from "../assets/dummyStyle";
...
const HomeVehicle = () => {
  ...
  const handleBook = (car) => {
    ...
    navigate(`/vehicle/${car._id || car.id}`, { state: { car } });
  };
    ...
    <div className={styles.container}>
      <div className={styles.headerContainer}>
        <div className={styles.premiumBadge}>
          ...
          <span className={styles.premiumText}>Fleet Selection</span>
        </div>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 w-full">
          <div className="w-full text-center">
            <h1 className={styles.title}>Car Collection</h1>
            <p className={styles.subtitle}>
              Discover vehicles with exceptional performance and comfort
