...
import { FaCar, FaCalendarAlt, FaMapMarkerAlt,  FaFilter,  FaTimes,  FaCheckCircle,  FaClock,  FaTimesCircle,  FaUser, FaCreditCard,  FaReceipt,  FaArrowRight,
} from "react-icons/fa";
    ...
    <div className={s.bookingCard}>
      ...
      <div className={s.cardContent}>
        ...
        <div className={s.cardActions}>
          ...
          <Link to="/vehicle" className={s.bookAgainButton}>
            <FaCar />
        ...
        <div className={s.modalContent}>
          <div className={s.modalHeader}>
            <h2 className={s.modalTitle}>
              <FaReceipt className="text-gray-800" /> Booking Details
            </h2>
          ...
          <div className={s.modalGrid}>
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center gap-2">
                <FaCalendarAlt className="text-gray-800" /> Booking Dates
              </h3>
              ...
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaMapMarkerAlt className="text-gray-800" /> Location Details
              </h3>
              <div className={s.infoCard}>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaUser className="text-gray-800" /> User Information
              </h3>
              <div className={s.infoCard}>
                <div className="mb-3">
              ...
              <h3 className="text-lg font-semibold flex items-center gap-2 mt-6">
                <FaCreditCard className="text-gray-800" /> Payment Details
              </h3>
              <div className={s.infoCard}>
                <div className="mb-3">
          ...
          <div className={s.modalActions}>
            ...
            <Link to="/vehicle" onClick={onClose} className={s.modalBookButton}>
